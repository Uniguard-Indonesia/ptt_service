...
package com.uniguard.humla.protocol;

import android.content.Context;
import android.media.AudioManager;
import android.util.Log;

import com.uniguard.humla.R;
import com.uniguard.humla.audio.AudioInput;
import com.uniguard.humla.audio.AudioOutput;
import com.uniguard.humla.audio.encoder.CELT11Encoder;
import com.uniguard.humla.audio.encoder.CELT7Encoder;
import com.uniguard.humla.audio.encoder.IEncoder;
import com.uniguard.humla.audio.encoder.OpusEncoder;
import com.uniguard.humla.audio.encoder.PreprocessingEncoder;
import com.uniguard.humla.audio.encoder.ResamplingEncoder;
import com.uniguard.humla.audio.inputmode.IInputMode;
import com.uniguard.humla.exception.AudioException;
import com.uniguard.humla.exception.AudioInitializationException;
...
import com.uniguard.humla.net.PacketBuffer;
import com.uniguard.humla.protobuf.Mumble;
import com.uniguard.humla.util.HumlaLogger;
import com.uniguard.humla.util.HumlaNetworkListener;
...
public class AudioHandler extends HumlaNetworkListener implements AudioInput.AudioInputListener {
    ...
    public interface AudioRecordListener {
        void onAudioRecorded(short[] frame, int frameSize);
    }
    ...
    public void onAudioInputReceived(short[] frame, int frameSize) {
        ...
        if (mIsRecording && mRecordListener != null) {
            mRecordListener.onAudioRecorded(frame, frameSize);
        }
