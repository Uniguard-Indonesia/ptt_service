...
import com.uniguard.humla.audio.AudioOutput;
import com.uniguard.humla.audio.BluetoothScoReceiver;
import com.uniguard.humla.audio.inputmode.ActivityInputMode;
import com.uniguard.humla.audio.inputmode.ContinuousInputMode;
import com.uniguard.humla.audio.inputmode.IInputMode;
import com.uniguard.humla.audio.inputmode.ToggleInputMode;
import com.uniguard.humla.audio.javacpp.CELT7;
import com.uniguard.humla.exception.AudioException;
import com.uniguard.humla.exception.NotConnectedException;
import com.uniguard.humla.exception.NotSynchronizedException;
import com.uniguard.humla.model.Channel;
...
import com.uniguard.humla.model.ServerSettings;
...
import com.uniguard.humla.model.WhisperTargetList;
import com.uniguard.humla.net.HumlaConnection;
import com.uniguard.humla.net.HumlaTCPMessageType;
...
import com.uniguard.humla.protocol.ModelHandler;
import com.uniguard.humla.util.HumlaCallbacks;
import com.uniguard.humla.util.HumlaDisconnectedException;
import com.uniguard.humla.util.HumlaException;
import com.uniguard.humla.util.HumlaLogger;
...
public class HumlaService extends Service implements IHumlaService, IHumlaSession, HumlaConnection.HumlaConnectionListener, HumlaLogger, BluetoothScoReceiver.Listener {
     ...
     */
    public static final String ACTION_CONNECT = "com.uniguard.humla.CONNECT";
...
//            auth.addCeltVersions(Constants.CELT_11_VERSION);
     ...
     * @see com.uniguard.humla.HumlaService
     */
     ...
     */
    protected AudioHandler getAudioHandler() throws NotSynchronizedException {
        if (!isSynchronized())
